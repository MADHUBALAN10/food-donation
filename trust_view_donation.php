            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="trust_view_donation.php">View Donation</a>                        </li>
                     <li class="nav-item">
            ...
            <div class="container">
                <div class="contactct-fm map-content-9">
                    <div class="header-title text-center">
                        ...
                        <h3 class="title-w3l mb-2">View Donation </h3>
                    ...
                    <form action="" class="pt-lg-4" method="post" enctype="multipart/form-data">
                      <table width="50%" height="127" align="center">
                        ...
                        <?php
	 $qrys1="select * from  payment_details where trust_id='$trust'";
