...
$password=$_REQUEST['password'];
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into trust_details values($sid,'$trust_name','$address','$email','$contact','$trust_name','$password','0','0')";
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="trust.php">Trust</a>                        </li>
                ...
                <div class="contactct-fm map-content-9">
                    ...
                    <form action="" class="pt-lg-4" method="post" enctype="multipart/form-data">
					  <table width="459" height="405" align="center">
                        <tr>
                          <td>Trust Name </td>
                          <td><input name="trust_name" type="text" id="trust_name" placeholder="Trust Name" required=""></td>
                        </tr>
                        <tr>
                          <td>Contact</td>
